...
TFFile(const TStr& _FPath, const TStr& _FExt,
...
static PFFile New(const TStr& FPath, const TStr& FExt,
                  const bool& RecurseP) {
...
static void GetFNmV(const TStr& FPath, const TStrV& FExtV,
                    const bool& RecurseP, TStrV& FNmV);

bool IsDir() const { return FFileDesc->IsDir(); }
}
;
